...
import com.example.horoscapp.ui.home.core.listeners.OnSwipeTouchListener
...
class LuckFragment : Fragment() {
    ...
    private fun slideCard() {
        val slideAppAnimation = AnimationUtils.loadAnimation(requireContext(), R.anim.slide_app)

        slideAppAnimation.setAnimationListener(object : Animation.AnimationListener {
        ...
        binding.ivReverse.startAnimation(slideAppAnimation)
    }
